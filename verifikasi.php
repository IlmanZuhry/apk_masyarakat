    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="dasboardptg.php">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="tanggapan2.php">
...
<?php
                        ...
                        <tr>
                            ...
                            <td scope="row">
                            <a href="tampilpengaduan2.php" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#edit<?php echo $id ?>"><i class="fas fa-fw fa-check"></i></a>
							<a href="tampilpengaduan2.php?op=hapus&Id=<?php echo $data['Id_pengaduan']?>" class="btn btn-danger"><i class="fas fa-fw fa-trash"></i></a>
                            </td>
                        </tr>
...
<div class="modal fade modal-lg"  id="edit<?php echo $id ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
       ...
       <form action="<?php $_SERVER['PHP_SELF']?>?op=Update" method="post" >
					<div class="mb-3 row">
						...
						<div class="col-sm-10">
							...
							value="<?php echo $db->manzbacaData1('Id_pengaduan',$id);?>" readonly>
						</div>
					</div>
					<div class="mb-3 row">
						...
						<div class="col-sm-10">
							...
							value="<?php echo $db->manzbacaData1('Tgl_pengaduan',$id);?>" readonly>
						</div>
					</div>
					<div class="mb-3 row">
						...
						<div class="col-sm-10">
							...
							value="<?php echo $db->manzbacaData1('Nik',$id);?>" readonly>
						</div>
					</div>
					<div class="mb-3 row">
						...
						<div class="col-sm-10">
							...
							value="<?php echo $db->manzbacaData1('Nama',$id);?>" readonly>
						</div>
					</div>
					<div class="mb-3 row">
						<label for="isi" class="col-sm-2 col-form-label">Isi Laporan</label>
						<div class="col-sm-10">
							<textarea type="text" class="form-control" name="isi" readonly><?php echo $db->manzbacaData1('Isi_laporan',$id);?></textarea>
						</div>
					</div>
					<div class="mb-3 row">
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.1/dist/js/bootstrap.bundle.min.js" integrity="sha384-u1OknCvxWvY5kfmNBILK2hRnQC3Pr17a+RTT6rIHI7NnikvbZlHgTPOOmMi466C8" crossorigin="anonymous"></script>
                ...
                <!-- Footer -->
              <center><footer class="sticky-footer bg-white">
