											...
											<form action="" method="post" enctype="multipart/form-data" >
												<div class="mb-3 row">
													...
													<div class="col-sm-10">
														...
														value="<?php echo $db->kode();?>" name="id" readonly>
													</div>
												</div>
												<div class="mb-3 row">
												...
												<div class="mb-3 row">
													...
													<div class="col-sm-10">
														...
														value="0" name="status" readonly>
													</div>
												</div>
												<br>
												<div class="col-12">
													<a href="pengaduan.php"><input type="submit" name="simpan" value="Simpan Data" class="btn btn-primary"></a>
													<input type="hidden" name="direktori" id="direktori" value="gambar"	/>
													<a href="pengaduan.php"><button type="button" class="btn btn-secondary">Kembali</button></a>
												</div>
											</form>
										</div>
									</div>
